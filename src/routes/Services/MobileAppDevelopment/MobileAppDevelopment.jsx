...
const MobileAppDevelopment = () => {
 ...
 {/* Title Card */}
 <section className="py-10 sm:py-40" style={{ backgroundImage: 'url("https://raw.githubusercontent.com/akhilthej/CSD_Website/c95062aaf0108bfcb5f6d078e5b59238a6ec1605/src/assets/CoverImages/MobileappCoverImage.png")', backgroundSize: 'cover', backgroundPosition: 'center' }}>
  <div className="flex flex-col items-center md:flex-row justify-center">
    ...
    <div className="md:w-1/2 px-5">
      <div className="text-right md:text-left"> {/* Align titles to the right on mobile, left on larger screens */}
        ...
        {MobileappServices.section1.title}
        </h1>
        <p className="text-white sm:text-sm text-xs text-center sm:ml-0">
        {MobileappServices.section1.subtitle}
        </p>
...
<div className="flex flex-wrap flex-row -mx-4 text-center justify-center">
  {GlobalData.MobileappServices.map((item, index) => (
    <div
