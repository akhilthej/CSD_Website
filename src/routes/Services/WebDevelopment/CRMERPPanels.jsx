...
const CRMERPPanels= () => {
  return (
    <div>
    {/* Title Card */}
    <section className="py-20 sm:py-40" style={{ backgroundImage: 'url("https://drive.google.com/uc?id=13w5Yma32HCf8xtmAn3mNa0rMyFjllIh-")', backgroundSize: 'cover', backgroundPosition: 'left' }}>
