...
<div className="flex items-center justify-center gap-4 flex-wrap">
  ...
  <button className="text-xs sm:text-sm transform rounded border border-slate-200 px-14 py-2 font-medium text-black transition-colors hover:bg-slate-50 hover:text-black">
    Contact us
        ...
        <section
          id="services"
          className="bg-gray-200 border-b cursor-default section relative pt-10 pb-8 md:pt-16 md:pb-10"
        >
          <div className="xl:max-w-8xl mx-auto px-4">
            ...
            <div className="flex flex-wrap flex-row -mx-4 text-center">
              ...
              >
                <div className="py-8 px-12 mb-12  border-gray-100 transform transition duration-300 ease-in-out hover:-translate-y-2">
