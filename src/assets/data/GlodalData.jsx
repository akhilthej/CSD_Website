...
const GlobalData = {
  company: {
    ...
    companyEmail: 'mail@cyberspacedigital.in',
  ...
  MobileappServices: [
    ...
    },
    {
      ...
      subtitle: 'Boost sales through affiliate programs.',
      slug: '/app-testing-and-quality-assurance',
      buttonText: 'Get Quotation',
    },
    {
      image: AppMaintenace, 
      ...
      subtitle: 'Gain insights from data for better strategies.',
      slug: '/app-maintenance-and-support',
      buttonText: 'Get Quotation',
    },
    {
      image: AppSecurity, 
    ...
    {
      image: AppMonetization, 
      title: 'App Monetization Strategy',
      subtitle: 'Target users on mobile devices.',
      slug: '/app-monetization-strategy',
      buttonText: 'Get Quotation',
    },
    {
      image: AppStore, 
