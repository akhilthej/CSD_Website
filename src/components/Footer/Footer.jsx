      ...
      <section className="bg-black pb-5">
        <footer>
          <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-9 lg:px-8">
            ...
            <p
              id="copyright"
              class="cursor-default text-center text-xs text-white"
            >
              © 2020-<span> {currentYear} </span> <br />
              www.cyberspacedigital.in
              <br />
              Web Development & Designer Community ( #CSD )
            </p>
          </div>
        </footer>
        <section />
        ...
        {/* WhatsApp us */}
        <div className="fade-in-left flex items-end justify-start fixed bottom-0 left-0 ml-2 mb-5 md:mb-1 z-10">
        <div>
          <a title="Whatsapp icon"
            href="https://wa.me/+918143407758"
            target="_blank"
            alt='whatsapp icon to contact Cyber Space Digital'
            className="block rounded-full transition-all transform hover:scale-110 hover:rotate-12" rel="noreferrer">
            <IoLogoWhatsapp className="object-cover object-center text-green-500 text-[35px]" /> {/* Use the WhatsApp icon */}
          </a>
        </div>
      </div>
    </main>
