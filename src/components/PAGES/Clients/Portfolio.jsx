...
import {LabelAnuneniwhite,LabelAnunenipc,Ilahewhite,Ilahepc} from '../../data/data'
        ...
        <div className="tracking-normal 2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
            <div className="flex flex-col lg:flex-row justify-between gap-8">
                <div className="w-full lg:w-5/12 flex flex-col justify-center">         
                    ...
                    <img className="fade-in-down mt-6 active mx-auto  w-full max-w-sm" src= {Ilahepc} alt="labelanunenimockup-2" />
                </div>
                <div className="w-full lg:w-8/12 ">
                    <img className="fade-in-down w-full max-w-xl mx-auto" src= {Ilahewhite} alt="labelanunenimockup" />
                    <h1 className="text-3xl lg:text-4xl font-bold leading-9 pb-4 text-pink-700">Tech Details</h1>
                    <p className="font-normal   text-base leading-6 text-white/70 ">Wordpress developed website. Custom forms and elementor pro used.</p>
                </div>
            </div>
        </div>
      </section>  
