...
<a className='text-lg font-medium '>Cyber Space Digital (CSD) believes in helping its customers as far as possible, and has therefore a liberal cancellation policy. Under this policy:</a><br />
...
<li className="py-2">Cyber Space Digital (CSD) does not accept cancellation requests for perishable items like flowers, eatables etc. However, refund/replacement can be made if the customer establishes that the quality of product delivered is not good.</li>
...
<li className="py-2">In case of any Refunds approved by the Cyber Space Digital (CSD), it’ll take 1-2 days for the refund to be processed to the end customer.</li>
