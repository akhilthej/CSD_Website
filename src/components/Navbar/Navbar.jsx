...
const mobileappLinks = [
  { path: '/mobile-app-design', title: 'Mobile App Design', description: 'Creative and user-friendly app design.', icon: faPalette },
  { path: '/ios-application-development', title: 'iOS App Development', description: 'Developing apps for iOS devices.', icon: faGlobe },
  { path: '/android-app-development', title: 'Android App Development', description: 'Building apps for Android platforms.', icon: faGlobe },
  { path: '/cross-platform-app-development', title: 'Cross-Platform App Development', description: 'Create apps compatible with multiple platforms.', icon: faGlobe },
  { path: '/app-prototyping', title: 'App Prototyping', description: 'Prototyping app concepts for validation.', icon: faDraftingCompass },
  { path: '/app-testing-and-quality-assurance', title: 'App Testing and Quality Assurance', description: 'Ensure app quality with rigorous testing.', icon: faCheckCircle },
  { path: '/app-maintenance-and-support', title: 'App Maintenance and Support', description: 'Ongoing maintenance and support services.', icon: faWrench },
  { path: '/app-security', title: 'App Security', description: 'Enhance app security and data protection.', icon: faShieldAlt },
  { path: '/app-monetization-strategy', title: 'App Monetization Strategy', description: 'Strategies for app revenue generation.', icon: faDollarSign },
  { path: '/app-store-optimization', title: 'App Store Optimization', description: 'Optimize apps for better visibility in stores.', icon: faSearch },
  { path: '/ecommerce-app-development', title: 'E-commerce App Development', description: 'Developing apps for e-commerce businesses.', icon: faShoppingBag },
];
