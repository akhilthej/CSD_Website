        ...
        <div class=" justify-end ">
            ...
            <Menu as="div" className="relative inline-block text-left ">
              <div>
                <Menu.Button className="lg:inline-flex font-semibold antialiased hidden justify-center w-full rounded-md  px-4 py-2  text-sm text-black hover:bg-yellow-500  focus:outline-none  ">
                  <Link to="/best-web-developement-company">Web Development</Link>
                  <svg
              ...
              >
                <Menu.Items className="origin-top-right fixed  right-0 mt-4 w-screen rounded-md shadow-lg bg-gray-300 ring-1 ring-black ring-opacity-5 divide-y divide-gray-400 focus:outline-none z-50">
                  <Menu.Item>
                    {({ active }) => (
          ...
          {/*Digital Marketing */}
            <Menu as="div" className="relative inline-block text-left ">
              <div>
                <Menu.Button className="lg:inline-flex font-semibold antialiased hidden justify-center w-full rounded-md  px-4 py-2  text-sm text-black hover:bg-yellow-500  focus:outline-none  ">
                  <Link to="/best-digital-marketing-company">Digital Marketing</Link>
                  <svg
                    xmlns="https://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
          ...
          {/*Branding */}
            <Menu as="div" className="relative inline-block text-left ">
              <div>
                <Menu.Button className="lg:inline-flex font-semibold antialiased hidden justify-center w-full rounded-md  px-4 py-2  text-sm text-black hover:bg-yellow-500  focus:outline-none  ">
                  <Link to="/best-brand-services-company">Brand Services</Link>
                  <svg
                    xmlns="https://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
          ...
          {/*Mobileapp */}
            <Menu as="div" className="relative inline-block text-left ">
              <div>
                <Menu.Button className="lg:inline-flex font-semibold antialiased hidden justify-center w-full rounded-md  px-4 py-2  text-sm text-black hover:bg-yellow-500  focus:outline-none  ">
                  <Link to="/best-mobile-app-development-company">Mobile App</Link>
                  <svg
                    xmlns="https://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
