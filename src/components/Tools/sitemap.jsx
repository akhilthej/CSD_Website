    ...
    <section>
        <div className='text-center justify-center'>
            ...
            <div className='glass px-10 py-10 mx-10 my-10'>
                    ...
                    <a href="/clients" class="font-medium text-orange-400 hover:text-orange-500 hover:underline cursor-pointer">Clients</a>
                    <a href="/getquotation" class="font-medium text-orange-400 hover:text-orange-500 hover:underline cursor-pointer">Get Quote</a>
                ...
                <div className='glass px-10 py-10 mx-10 my-10'>
                    ...
                    <a href="/blockchain-development" class="font-medium text-orange-400 hover:text-orange-500 hover:underline cursor-pointer">Blockchain</a>
                    <a href="/rust-development" class="font-medium text-orange-400 hover:text-orange-500 hover:underline cursor-pointer">Rust</a>
                    <a href="/solidity-development" class="font-medium text-orange-400 hover:text-orange-500 hover:underline cursor-pointer">Solidity</a>
                    <a href="/pwa-apps-development" class="font-medium text-orange-400 hover:text-orange-500 hover:underline cursor-pointer">PWA</a>
                    <a href="/android-studio-development" class="font-medium text-orange-400 hover:text-orange-500 hover:underline cursor-pointer">Android Studio</a>
                    <a href="/bootstrap-development" class=" font-medium text-orange-400 hover:text-orange-500 hover:underline cursor-pointer">Bootstrap</a>
                    <a href="/wordpress-development" class="font-medium text-orange-400 hover:text-orange-500 hover:underline cursor-pointer">Wordpress</a>
                    <a href="/unity-development" class=" font-medium text-orange-400 hover:text-orange-500 hover:underline cursor-pointer">Unity 3D</a>
                    </a>
                </div>
                ...
                <div className='glass px-10 py-10 mx-10 my-10'>
                    ...
                    <a className='md:flex grid justify-center mt-10 space-x-4'>
                    <a href="/contactus" class="font-medium text-orange-400 hover:text-orange-500 hover:underline cursor-pointer">Contact us</a>
                    <a href="/getquotation" class="font-medium text-orange-400 hover:text-orange-500 hover:underline cursor-pointer">Get A Quote</a>
                    <a href="/clients" class="font-medium text-orange-400 hover:text-orange-500 hover:underline cursor-pointer">Portfolio</a>
                    <a href="/reviews" class="font-medium text-orange-400 hover:text-orange-500 hover:underline cursor-pointer">Reviews</a>
                    <a href="/privacypolicy" class=" font-medium text-orange-400 hover:text-orange-500 hover:underline cursor-pointer">Privacy Policy</a>
                    <a href="/termsofuse" class="font-medium text-orange-400 hover:text-orange-500 hover:underline cursor-pointer">Terms of Use</a>
                    <a href="/sitemap" class=" font-medium text-orange-400 hover:text-orange-500 hover:underline cursor-pointer">Site Map</a>
                    </a>
                </div>
